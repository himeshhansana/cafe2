 ...
 * @author hansa
 */
public class StatisticsReports extends javax.swing.JPanel {
    ...
    /**
     * Creates new form StatisticsReports
     */
    public StatisticsReports(cafe2.AdminHome aThis) {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Statictis Dashboard", jPanel1);

        jPanel3.setBackground(new java.awt.Color(158, 111, 78));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imges/icons8-human-resources-30.png"))); // NOI18N
        ...
        jTabbedPane1.addTab("Statictis ", jPanel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String TotalProducts = jLabel2.getText();
            String TodayRevenue = jLabel3.getText();
            String TotalRevenue = jLabel5.getText();
            String TotalAdmin = jLabel6.getText();
            String dateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());

            InputStream s = this.getClass().getResourceAsStream("/reports/report25.jasper");

            HashMap<String, Object> parametes = new HashMap<>();
            parametes.put("Parameter1", dateTime);
            parametes.put("Parameter2", TotalProducts);
            parametes.put("Parameter3", TodayRevenue);
            parametes.put("Parameter4", TotalRevenue);
            parametes.put("Parameter5", TotalAdmin);
